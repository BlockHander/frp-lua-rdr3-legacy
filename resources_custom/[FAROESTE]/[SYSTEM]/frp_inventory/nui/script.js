...
window.addEventListener("message", function(event) {
    if (event.data.action == 'hide') {
        ...
        if (event.data.type == 'nextHotbarSlot1' || event.data.type == 'previousHotbarSlot') {
        ...
        if (event.data.type == 'nextHotbarSlot2' || event.data.type == 'previousHotbarSlot') {
...
if (event.data.type == 'nextHotbarSlot3' || event.data.type == 'previousHotbarSlot') {
...
if (event.data.type == 'nextHotbarSlot4' || event.data.type == 'previousHotbarSlot') {
...
itemId: itemId,
        ...
        if (event.data.type == 'nextHotbarSlot5' || event.data.type == 'previousHotbarSlot') {
