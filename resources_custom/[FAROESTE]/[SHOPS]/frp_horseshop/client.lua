...
Citizen.CreateThread(
	function()
		WarMenu.CreateMenu('horses', 'Lovarda')
		WarMenu.SetSubTitle('horses', 'Válassz ki egy opciót')
		WarMenu.CreateSubMenu('horse_shop', 'horses', 'Ló vásárlása')
		WarMenu.CreateSubMenu('my_horses', 'horses', 'Tulajdonban lévő lovak')
		while true do
			if WarMenu.IsMenuOpened('horses') then
				WarMenu.MenuButton('Ló vásárlása', 'horse_shop')

				if WarMenu.MenuButton('Tulajdonban lévő lovak', 'my_horses') then
